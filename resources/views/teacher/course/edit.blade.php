                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('course-update', ['id' => $course->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="code" value="{{$course->code}}" class="form-control" placeholder="code">
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label class="col-sm-3 col-form-label">CourseDuration</label>
                                <div class="col-sm-9">
                                    <input type="number" name="duration" value="{{$course->duration}}" class="form-control" placeholder="duration" min="1" max="6">
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea  name="shortDescription" class="form-control" rows="2">{{$course->shortDescription}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label class="col-sm-3 col-form-label">LongDescription</label>
                                <div class="col-sm-9">
                                    <textarea  name="longDescription" class="form-control" rows="4">{{$course->longDescription}}</textarea>
                                </div>
                            </div>
